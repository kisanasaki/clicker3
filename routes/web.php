...
Route::get('/Rowdata/{data}','BrainWavesController@Rowdata')->name('Rowdata');
...
//ルーティング追加
Route::get('/rawdata','BrainwavesController@rawdata')->name('rawdata');
Route::post('/rawdata','BrainwavesController@rawdata')->name('rawdata');
